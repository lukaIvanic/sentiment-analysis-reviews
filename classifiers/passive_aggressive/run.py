"""Train and evaluate a TF-IDF + PassiveAggressiveClassifier sentiment classifier."""
...
DEFAULT_OUTPUT_DIR = OUTPUTS_DIR / "baselines" / "passive_aggressive"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and evaluate PassiveAggressiveClassifier on Kaggle IMDb reviews.",
    )
    parser.add_argument(
        "--csv-path",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Maximum step size / aggressiveness parameter.",
    )
    parser.add_argument(
        "--max-iter",
        type=int,
...
def main() -> None:
    ...
    print(f"Saved PassiveAggressiveClassifier artifacts to {args.output_dir}")
    ...
    print("Log-loss: unavailable for PassiveAggressiveClassifier")
